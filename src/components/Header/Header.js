        ...
        >
          ...
          {showMenu && (
            ...
            >
              ...
              {!IS_ETH && <StyledHeaderLink href="https://component.duck.limo/" target="_blank">Component on ETH</StyledHeaderLink>}
              {!IS_BSC && <StyledHeaderLink href="https://bsc.component.duck.limo/" target="_blank">Component on BSC</StyledHeaderLink>}
              {!IS_XDAI && <StyledHeaderLink href="https://xdai.component.duck.limo/" target="_blank">Component on Gnosis chain</StyledHeaderLink>}
              {!IS_FTM && <StyledHeaderLink href="https://ftm.component.duck.limo/" target="_blank">Component on FTM</StyledHeaderLink>}
              ...
              <StyledHeaderLink href="https://docs.component.duck.limo/" target="_blank">Docs</StyledHeaderLink>
              <Button onClick={() => {
